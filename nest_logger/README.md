...
7. 
8. In your newly created sheet, click on the Tools / Script editor in the toolbar and upload the four google scripts files of this repository.
9. In your script editor, select the file called `helperFunctions.gs`and run the function called `giveMeRedirectURI`. This will return a URL in your console. Copy that URL and paste it in the appropriate credential section of your google console (the one you created at step 4).
...
10. Back in your Device Access Console, create a new project
11. When prompted, add the OAuth client ID from your Google Cloud project to this new Smart Device project. You took note of this at step 4.
    
    ![image](https://user-images.githubusercontent.com/696901/137586264-c84feaa0-a0d3-4599-8182-dac5c8c0567a.png)
    
12. Activate your Nest device(s) when prompted during project creation.
13. Take note of your `Project_ID` 
    
    ![image](https://user-images.githubusercontent.com/696901/137586284-4d363fd5-d28b-4074-a716-d35b1a7ce108.png)
    
14. Go back to your script editor (same as point 7) and add the `oauth2`library following the directions below:
...
15. Create an Openweather app it token following instructions [https://openweathermap.org/appid](https://openweathermap.org/appid). Take note of your Key from your openweather console.
    
    ![image](https://user-images.githubusercontent.com/696901/137586310-0f82041c-49e4-47f6-bab5-b547b1fb7253.png)
    
16.  Find the openweather station code for your city. Look for your city on the openweather site and take note of the city ID in the URL. For instance, the city ID for London, GB is 2643743.
    
    ![image](https://user-images.githubusercontent.com/696901/137586319-aeed77ef-a874-4e35-a847-cb761bb2743e.png)
    
17. Go back to your script editor and select the file called `globalVariables.gs`. Now you have all the values you need to enter. The only value you have not collected yet is the serial number of your thermostat. You can find that value on the thermostat itself, in the settings page of the thermostat, or on the nest app on your phone. See [here](https://support.google.com/googlenest/thread/15621991/where-do-i-find-the-model-for-my-nest-thermostat?hl=en) if you need help. 
...
18. Now from the editor select the file called `[oauth2.gs](http://oauth2.gs)` and run the function `logRedirectUri`. This will output a URL. Open that URL in another browser tab and authorise everything you need to authorise.
19. Finally, open the file called `code.gs`and run the function called `logMeasurement`. If everything is setup properly you should see the first line of data logged in the spreadsheet you created at step. 
20. If step 19 was successful, all you need to add is a time trigger. Click on trigger, then find the "+ Add trigger" button on the bottom right corner and add a timed trigger. 
...
21. I run mine every 15 minutes.
